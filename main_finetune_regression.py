...
from engine_finetune import train_one_epoch, train_reg_one_epoch, evaluate, evaluate_reg
...
def main(args):
    ...
    if args.eval:
        ...
        print(f"MAE of the network on the {len(dataset_val)} test images: {test_stats['mae']:.1f}%")
        exit(0)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_reg_one_epoch(
