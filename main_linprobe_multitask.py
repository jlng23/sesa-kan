...
from engine_finetune import train_one_epoch, evaluate, evaluate_reg, evaluate_multi, train_multi_one_epoch
...
def get_args_parser():
    ...
    parser.add_argument('--criterion', default= 'simple_weighted_loss', type=str,
                        help='loss function')
...
def main(args):
    ...
    best_mse, best_f1 = float('inf'), float('inf')
